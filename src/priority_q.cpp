...
template <typename T>
void pq_heap<T>::display() {
    heap_.display();
}

template <typename T>
void pq_heap<T>::clear() {
    heap_.clear();
}
...
=======
template class pq_heap<double>;
template class pq_heap<std::string>;

template class pq_list<int>;
template class pq_list<double>;
template class pq_list<std::string>;
>>>>>>> 6914417d7699cfa31f3ae194714712ea7ab00c99
